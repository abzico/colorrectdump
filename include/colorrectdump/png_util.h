#ifndef CRD_PNG_UTIL_H_
#define CRD_PNG_UTIL_H_
 ...
 */
extern void crd_free_png_image_data(png_bytepp data, int height);
 ...
 */
extern png_bytepp crd_allocate_png_rgba_image_space(int width, int height);
 ...
 */
extern png_bytepp crd_read_png_file(const char* file_name, int* rst_rowbytes, int* rst_width, int* rst_height);
 ...
 */
extern bool crd_write_png_file(const char* file_name, const png_bytepp data, int width, int height);
